...
<body>
    ...
    <div class="section">
        <div class="content">
            ...
            $sql = "SELECT topics.id_topics, users.username, topics.title, topics.created_at FROM topics JOIN users ON topics.user_id = users.id_user";
                ...
                <table>
                    ...
                    <?php foreach ($forums as $forum) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="forum-settings.php?delete_id=<?php echo $forum['id_topics']; ?>" onclick="return confirm('Are you sure you want to delete this forum?')">Delete</a>
