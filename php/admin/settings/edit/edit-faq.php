...
$id_faqs = $_GET['id_faqs'];
$query = "SELECT * from faq WHERE id_faqs = '$id_faqs'";
...
if (isset($_POST['simpan'])) {
    ...
    $query = "UPDATE faq SET  Pertanyaan = '$pertanyaan', Jawaban = '$jawaban'  WHERE id_faqs = '$id_faqs'";
    $result = mysqli_query($conn, $query);
        ...
        <div class="content">
            ...
            <div class="settings-form">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="Jawaban" value="<?php echo $faqs['Jawaban']; ?>" required><br>
