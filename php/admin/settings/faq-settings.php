    ...
    <div class="section">
        <div class="content">
            ...
            if (isset($_GET['delete_id'])) {
                ...
                $deleteSql = "DELETE FROM faq WHERE id_faqs = $deleteId";
            ...
            <h1>FAQ Settings</h1>
            <div class="box">
                <a href="add-faq.php" class="add-faq">Add New faq</a>
                <table>
                    <tr>
                        <th>No</th>
                        <th>Question</th>
                    ...
                    <?php foreach ($faqs as $faq) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="faq-settings.php?delete_id=<?php echo $faq['id_faqs']; ?>" onclick="return confirm('Are you sure you want to delete this forum?')">Delete</a>
                                <a href="edit/edit-faq.php?id_faqs=<?php echo $faq['id_faqs']; ?>">Edit</a>
                            </td>
                        </tr>
                        <?php $count++; ?>
                    <?php endforeach; ?>
